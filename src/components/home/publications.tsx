...
const ImagePlaceholder = ({ imageData, alt }) => {
    if (imageData) {
        return (<GatsbyImage image={imageData} alt={alt} className="w-60 h-40 object-cover" />)
    }
    return (
        <div className="bg-gray-200 flex items-center justify-center w-60 h-40 object-cover">
